	...
	fetch(restUrl+'/events/')
		...
		.then(events => {
			...
			events.forEach(event => {
				...
				newLi.innerHTML = '<div>'+
					'<p class="festivals__item-id">ID= '+eventId+'</p>'+
					'<h3 class="festivals__item-title">title= '+eventTitle+'</h3>'+
					'<h4 class="festivals__item-subtitle">subtitle= '+eventSubtitle+'</h4>'+
					'<p class="festivals__item-desc_title">desc_title= '+eventDescTitle+'</p>'+
					'<p class="festivals__item-desc_lead">desc_lead= '+eventDescLead+'</p>'+
					'<p class="festivals__item-desc_text">desc_text= '+eventDescText+'</p>'+
					'<p class="festivals__item-genre_id">genre_id= '+eventGenreId+'</p>'+
					'<p class="festivals__item-genre_id_as_text">genre_id_as_text= '+eventGenreIdAsText+'</p>'+
					'<p class="festivals__item-location_id">location_id= '+eventLocationId+'</p>'+
...
// Funktion sofort ausführen
rewriteGenreIdToText()


//! Genre ID in Slug umwandeln
...
// //! GenreID in Name umwandeln –– DEFEKT
