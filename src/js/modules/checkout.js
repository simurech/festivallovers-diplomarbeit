...
//! Handling für Formular
// Wechsle zur Seite "Bestellbestätigung"
...
// Klick auf Submit Button startet validateForm Funktion
document.querySelector('#bestellenBtn').addEventListener('click', validateForm);

// Gesamtkosten aus LocalStorage auslesen und Button ändern, nach 2s auf Bestellbestätigung weiterleiten
...
// Zahlungsart auslesen und neben Kreditkarte Logo in Feld einfügen + Label umranden
...
// Wenn Zahlungsart gewählt Funktion getPaymentMethod ausführen
funktionBeiKlick('paymentradio', getPaymentMethod);
// Rahmen von Label zurücksetzen (Wird in Funktion getPaymentMethod aufgerufen)
